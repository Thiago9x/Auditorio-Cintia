...
class Calendar {
    constructor(id) {
        ...
        this.calendario = document.getElementById(id);
        this.showTemplate();
        this.elGridBody = this.calendario.querySelector('.grid__body');
        this.nomeMeses = this.calendario.querySelector('.month-name');
        this.showCells();
    }

    showTemplate() {
        this.calendario.innerHTML = this.getTemplate();
    ...
    getTemplate() {
        let template = `
            <div class="calendar__header">
                ...
                <span class="month-name">dez 2021</span>
    ...
    addEventListenerToControls() {
        let elControls = this.calendario.querySelectorAll('.control');
    ...
    showCells() {
        ...
        if (this.cells === null) {
            console.error('Não foi possivel gerar as datas do calendário');
            return;
        }
        ...
        this.nomeMeses.innerHTML = this.currentMonth.format('MMM YYYY');
    ...
    addEventListenerToCells() {
        let elCells = this.calendario.querySelectorAll('.grid__cell--gd');
        elCells.forEach(elCell => {
            elCell.addEventListener('click', e => {
                ...
                this.calendario.dispatchEvent(new Event('change'));
            });
        });
    }
